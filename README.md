...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1264%20passing-00d4ff?style=flat-square" alt="tests" />
...
| **1264 passing tests** | CLI integration, harness adapters, schema/bundler/publish, watcher/scheduler, market, design, profile management, hook fail-safe resilience, secret-scan hardening, plugin manifest schema, transcript-reader, event emitter, vault frontmatter |
...
```bash
npm install
npm test           # 1264 tests across 221 suites
