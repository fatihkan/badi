...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1333%20passing-00d4ff?style=flat-square" alt="tests" />
...
- **Tested** — 1333 passing tests, with releases gated on a docs/security sync check.
...
```bash
npm install
npm test           # 1333 tests across 237 suites
