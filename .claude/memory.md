...
- npm: @fatihkan/badi v1.28.1 (yayinda) — 16.05.2026 help-doctor CI + 6 security finding kapali
- main: v1.29 observability merged (PR #173, henuz npm'de degil) — session/search/plan/cost
- Tests: 967 (Linux+macOS yesil; Windows non-blocking)
...
- 2026-05-16 (gec seans): v1.29 observability paketi merge edildi
  ...
  *.jsonl` transcript'lerini direk okur (privacy-preserving).
  ...
  967 (+33). Yayin v1.29.0 minor bump bekliyor.
