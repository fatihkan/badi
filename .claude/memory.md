...
- npm: @fatihkan/badi v1.30.0 (yayinda) — 19.05.2026 5-feature bundle + 11 hotfix bulgu
- Tests: 1054 (Linux+macOS yesil; Windows non-blocking)
...
- `lib/commands/release.js` CHECKS array (v1.30+) — 9 pure check fonksiyonu, plugin'ler `CHECKS.push()` ile genisletebilir
