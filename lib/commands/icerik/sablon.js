...
export function runSablon(args) {
	...
	if (!sablonSub || sablonSub === "--help" || sablonSub === "-h") {
		...
		console.log("  post, carousel, video, visual, calendar");
		return;
	}
	...
	if (sablonSub === "create") {
		...
		const validBases = ["post", "carousel", "video", "visual", "calendar"];
...
`;
	...
	if (sablonSub === "list") {
		...
		console.log(chalk.dim("  post, carousel, video, visual, calendar, brand"));
		console.log("");
