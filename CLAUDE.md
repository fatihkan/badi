...
> Claude Code icin yapilandirilmis operasyon yonetimi. 26 ajan, 81 komut, 14 hook, 62 opt-in skill kategorisi. v1.20+ prompt-aware skill router; v1.25+ pentest-* ailesi (25 kategori, advisory/defensive); v1.26+ profil bazli komut yonetimi (core/dev/content/pentest) + komut routing; v1.27+ expo-* ailesi (12 kategori, Expo + React Native mobile dev lifecycle); v1.32+ sanal eng ekibi (product-strategist, engineering-manager, release-manager, qa-lead + /ceo-review, /eng-review, /qa, /ship).
...
| Commands Vault | `.claude/commands-vault/` | 81 komut canonical (v1.26+), yuklenmez |
